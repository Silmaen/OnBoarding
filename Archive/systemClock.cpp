...
#ifndef NO_CLOCK
PROGMEM constexpr uint8_t
ds3231TransactionTimeout = 100;   ///< Wire NAK/Busy timeout in ms

PROGMEM constexpr uint32_t
secondsFrom1970To2000 = 946684800;
...
PROGMEM constexpr uint8_t
ds3231TimeCalAddr = 0x00;
PROGMEM constexpr uint8_t
ds3231Alarm1Addr = 0x07;
PROGMEM constexpr uint8_t
ds3231Alarm2Addr = 0x0B;
PROGMEM constexpr uint8_t
ds3231ControlAddr = 0x0E;
PROGMEM constexpr uint8_t
ds3231StatusAddr = 0x0F;
PROGMEM constexpr uint8_t
ds3231AgingOffsetAddr = 0x10;
PROGMEM constexpr uint8_t
ds3231TemperatureAddr = 0x11;

// control register bits
PROGMEM constexpr uint8_t
ds3231ControlA1Ie = 0x1;    ///< Alarm 2 Interrupt Enable
PROGMEM constexpr uint8_t
ds3231ControlA2Ie = 0x2;    ///< Alarm 2 Interrupt Enable
PROGMEM constexpr uint8_t
ds3231ControlIntcn = 0x4;    ///< Interrupt Control */
PROGMEM constexpr uint8_t
ds3231ControlRs1 = 0x8;    ///< square-wave rate select 2
PROGMEM constexpr uint8_t
ds3231ControlRs2 = 0x10;    ///< square-wave rate select 2
PROGMEM constexpr uint8_t
ds3231ControlConv = 0x20;    ///< Convert Temperature
PROGMEM constexpr uint8_t
ds3231ControlBbsqw = 0x40;    ///< Battery-Backed Square-Wave Enable
PROGMEM constexpr uint8_t
ds3231ControlEosc = 0x80;    ///< not Enable Oscillator, 0 equal on


// status register bits
PROGMEM constexpr uint8_t
ds3231StatusA1F = 0x01;    ///< Alarm 1 Flag
PROGMEM constexpr uint8_t
ds3231StatusA2F = 0x02;    ///< Alarm 2 Flag
PROGMEM constexpr uint8_t
ds3231StatusBusy = 0x04;    ///< device is busy executing TCXO
PROGMEM constexpr uint8_t
ds3231StatusEn32Khz = 0x08;    ///< Enable 32KHz Output
PROGMEM constexpr uint8_t
ds3231StatusOsf = 0x80;    ///< Oscillator Stop Flag
#endif
namespace ob::core {
...
// helpers
    ...
    void systemClock::setTime(uint8_t
    hours,
    uint8_t minutes, uint8_t
    seconds) {
    internalTime.
    hour = hours;
    internalTime.
